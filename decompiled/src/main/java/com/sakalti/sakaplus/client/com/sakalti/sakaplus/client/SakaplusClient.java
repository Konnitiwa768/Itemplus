...
public class SakaplusClient implements ClientModInitializer
{
    public void onInitializeClient() {
        EntityRendererRegistry.register((class_1299)ModEntities3333.TOTU_TAKUMI, TotuTakumiRenderer::new);
        EntityRendererRegistry.register((class_1299)ModEntities3333.KOURI_TAKUMI, KouriTakumiRenderer::new);
        EntityRendererRegistry.register((class_1299)ModEntities33332.NUCREEPER, NucreeperRenderer::new);
