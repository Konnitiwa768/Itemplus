...
public class NyankoModel extends SinglePartEntityModel<NyankoEntity> {
    ...
    @Override
    public void setAngles(NyankoEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // 足のパタパタ
        float speed = 1.0F;
        float degree = 1.0F;
