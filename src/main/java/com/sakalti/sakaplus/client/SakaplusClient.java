...
import com.sakalti.sakaplus.parasitory.client.renderer.ShiberRenderer;
...
public class SakaplusClient implements ClientModInitializer
{
    public void onInitializeClient() {
        ...
        EntityModelLayerRegistry.registerModelLayer(ShiberRenderer.LAYER, UgnazhiModel::getTexturedModelData);
        EntityRendererRegistry.register((class_1299)ParasitoryEntities.SHIBER, ShiberRenderer::new);
    }
}
