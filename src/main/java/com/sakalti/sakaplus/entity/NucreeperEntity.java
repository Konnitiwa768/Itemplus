...
public class NucreeperEntity extends class_1548
{
    public NucreeperEntity(final class_1299<? extends class_1548> entityType, final class_1937 world) {
        super((class_1299)entityType, world);
        this.method_7005(1);
        if (!world.field_9236) {
            final CreeperEntityAccessor accessor = (CreeperEntityAccessor)this;
            accessor.setFuseTime(50);
    ...
    public static class_5132.class_5133 createNucreeperAttributes() {
        return class_1548.method_26828().method_26868(class_5134.field_23716, 35.0).method_26868(class_5134.field_23724, 8.0).method_26868(class_5134.field_23717, 24.0).method_26868(class_5134.field_23719, 0.3);
    }
}
