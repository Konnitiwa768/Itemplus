...
public class ModEntities
{
    ...
    public static void registerAll() {
        FabricDefaultAttributeRegistry.register((class_1299)ModEntities.TOTU_TAKUMI, TotuTakumiEntity.createTotuTakumiAttributes());
        FabricDefaultAttributeRegistry.register((class_1299)ModEntities.KOURI_TAKUMI, KouriTakumiEntity.createKouriTakumiAttributes());
        ModEntities.TOTU_TAKUMI = registerCreeper("totu_takumi", (class_1299.class_4049<TotuTakumiEntity>)TotuTakumiEntity::new, 0.6f, 1.7f, 80);
        ModEntities.KOURI_TAKUMI = registerCreeper("kouri_takumi", (class_1299.class_4049<KouriTakumiEntity>)KouriTakumiEntity::new, 0.6f, 1.7f, 80);
        ...
        }, class_1311.field_6302, (class_1299)ModEntities.TOTU_TAKUMI, 40, 1, 3);
        BiomeModifications.addSpawn(context -> {
        ...
        }, class_1311.field_6302, (class_1299)ModEntities.KOURI_TAKUMI, 35, 1, 2);
    }
