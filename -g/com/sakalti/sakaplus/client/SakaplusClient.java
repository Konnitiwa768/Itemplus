...
import com.sakalti.sakaplus.entity.ModEntities3332;
...
import com.sakalti.sakaplus.entity.ModEntities333;
import net.fabricmc.api.ClientModInitializer;

public class SakaplusClient implements ClientModInitializer
{
    public void onInitializeClient() {
        EntityRendererRegistry.register((class_1299)ModEntities333.TOTU_TAKUMI, TotuTakumiRenderer::new);
        EntityRendererRegistry.register((class_1299)ModEntities333.KOURI_TAKUMI, KouriTakumiRenderer::new);
        EntityRendererRegistry.register((class_1299)ModEntities3332.NUCREEPER, NucreeperRenderer::new);
