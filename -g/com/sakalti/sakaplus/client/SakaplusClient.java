...
import com.sakalti.sakaplus.entity.ModEntities32;
...
import com.sakalti.sakaplus.entity.ModEntities3;
import net.fabricmc.api.ClientModInitializer;

public class SakaplusClient implements ClientModInitializer
{
    public void onInitializeClient() {
        EntityRendererRegistry.register((class_1299)ModEntities3.TOTU_TAKUMI, TotuTakumiRenderer::new);
        EntityRendererRegistry.register((class_1299)ModEntities3.KOURI_TAKUMI, KouriTakumiRenderer::new);
        EntityRendererRegistry.register((class_1299)ModEntities32.NUCREEPER, NucreeperRenderer::new);
